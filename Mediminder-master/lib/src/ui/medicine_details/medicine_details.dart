      ...
      body: Container(
        child: Padding(
          ...
          child: Column(
            ...
            children: <Widget>[
              MainSection(medicine: medicine , key:null,),
              SizedBox(
                height: 15,
              ),
...
class MainInfoTab extends StatelessWidget {
  ...
  MainInfoTab({Key key, this.fieldTitle, this.fieldInfo})
      : super(key: key);
...
class ExtendedSection extends StatelessWidget {
  ...
  ExtendedSection({Key key, this.medicine}) : super(key: key);
